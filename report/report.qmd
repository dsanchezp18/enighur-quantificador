...
sankey_static_candidates <- c(
  file.path("..", "output", "figures", "sankey_ingresos_gastos_2025.svg"),
  file.path("..", "output", "figures", "sankey_ingresos_gastos_2025.png")
)
sankey_static_path <- sankey_static_candidates[file.exists(sankey_static_candidates)][1]
...
} else if (!is.na(sankey_static_path)) {
  knitr::include_graphics(sankey_static_path)
} else {
  knitr::asis_output(
...
include_preferred_graphic(c(
  file.path("..", "output", "figures", "distribucion_ingreso_2025.svg"),
  file.path("..", "output", "figures", "distribucion_ingreso_2025.png")
))
```
...
include_preferred_graphic(c(
  file.path("..", "output", "figures", "gasto_total_por_quintil_ingreso_2025.svg"),
  file.path("..", "output", "figures", "gasto_total_por_quintil_ingreso_2025.png")
))
```
...
include_preferred_graphic(c(
  file.path("..", "output", "figures", "gasolina_promedio_por_quintil_2025.svg"),
  file.path("..", "output", "figures", "gasolina_promedio_por_quintil_2025.png")
))
```
...
include_preferred_graphic(c(
  file.path("..", "output", "figures", "gasto_total_mediano_provincia_2025.svg"),
  file.path("..", "output", "figures", "gasto_total_mediano_provincia_2025.png")
))
```
...
include_preferred_graphic(c(
  file.path("..", "output", "figures", "productos_alimentos_mas_presentes_region_2025.svg"),
  file.path("..", "output", "figures", "productos_alimentos_mas_presentes_region_2025.png")
))
```
