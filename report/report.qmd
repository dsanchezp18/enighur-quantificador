...
El gráfico 1 muestra cómo el ingreso de los hogares se distribuye en diferentes tipos de gasto para el hogar promedio. La gran mayoría de este ingreso se dedica a gasto corriente, con un promedio de $642 (72.2% del ingreso monetario). El gasto corriente es gasto de "corto plazo"^[Formalmente, gasto en bienes y servicios dedicado a satisfacer necesidades y deseos cotidianos.]. Si además se suma el gasto de no consumo, el hogar promedio destina el 77% de su ingreso monetario a gastos totales ($684 de $889). Además, determino que: 
