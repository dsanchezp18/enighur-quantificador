...
Los hogares no han cambiado mucho la forma en la que gastan (en terminso proporcionales). El componenet que mas ha cambiado es el de la Vivienda y servicios, que representa en 2025 una mayor importancia dentro del presupuesto del hogar (10.9% vs. 7.4% en 2012).
...
<div style="width: 100%; max-width: 100%; margin: 1.5rem 0;">
<iframe
  src="../output/figures/sankey_ingresos_gastos_interactivo.html"
  style="display: block; width: 100%; height: 980px; border: 0;"
  loading="lazy"
></iframe>
</div>
...
![](../output/figures/distribucion_ingreso_2012_2025.png)

Se hablo mucho en semanas pasadas de cuantos hogares ganan $1.500 dolares o mas. La ENIGHUR confirma, de manera fulminante, lo que tambien sugiere la ENEMDU: solo 14.7% de familias gana $1,500 o mas. El 90% de familias gana solo hasta $1.826. El 1%, representando a un grupo _muy_ selecto de hogares, gana $4,465 mensuales o mas. En terminos de desigualdad, es decir, que tanto porcentaje de ingresos se llevan los diferentes grupos de la sociedad, el Ecuador tiene una puntuacion de 0.452 (coeficiente de Gini). En 12 anios, el valor ha mejorado marginalmente (0.466). Este valor es de los mas altos de Latinoamerica, superado solo por Nicaragua, Brazil, Panama y COLOMBIA, SEGUN el banco mundial [aqui](https://data.worldbank.org/indicator/SI.POV.GINI?locations=C6&most_recent_value_desc=true). 

# Los hogares rurales ganan y gastan considerablemente menos

Los hogares urbanos

Un detalle a notar es que el ingreso por agricultura toma muchisima mas importancia en los hogares rurales, representando, en promedio, el 10.7% de los ingresos rurales. En la zona urbana, el mismo no llega al 1%. 

# Los hogares mas ricos... 

# La provincia mas cara para vivir es xxxx

# Las familias de xxxx gastan mas en estupefacientes

# El gasto en salud...

edad vs. gto salud scatterplot. 
