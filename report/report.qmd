...
Se hablo mucho en semanas pasadas de cuantos hogares ganan $1.500 dolares o mas. La ENIGHUR confirma, de manera fulminante, resultados ENEMDU: solo 14.1% de familias gana $1,500 o mas. El 90% de familias gana solo hasta $1.826. El 1%, representando a un grupo _muy_ selecto de hogares, gana $4,465 mensuales o mas. 

En terminos de desigualdad, es decir, que tanto porcentaje de ingresos se llevan los diferentes grupos de la sociedad, el Ecuador tiene una puntuacion de 0.452 (coeficiente de Gini). En 12 anios, el valor ha mejorado marginalmente (0.466). UEste valor es de los mas altos de Latinoamerica, superado solo por Nicaragua, Brazil, Panama y COLOMBIA, SEGUN el banco mundial [aqui](https://data.worldbank.org/indicator/SI.POV.GINI?locations=C6&most_recent_value_desc=true). 
